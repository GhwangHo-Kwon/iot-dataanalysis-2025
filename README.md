...
- [주피터노트북](./day05/mldl01_케라스_합성곱신경망.ipynb)

### 파이토치 맛보기
- 파이토치 시작하기

- [주피터노트북](./day05/mldl02_파이토치시작.ipynb)
...
- [주피터노트북](./day06/mldl01_파이토치_기본.ipynb)

### 파이토치 실습
- 파이토치로 Fashion-MNIST 실습
- Keras CNN과 비교해서 학습할 것!

- [주피터노트북](./day06/mldl02_파이토치_합성곱신경망.ipynb)
...
- [주피터노트북](./day07/mldl01_Cats_and_Dogs_이진분류.ipynb)
...
- Kaggle 참조노트북
    - [주피터노트북](./day07/zzaebok-cat-vs-dog.ipynb)
...
- YOLO(You Only Look Once) - 객체 탐지, 이미지 분할 등을 위한 딥러닝 모델
    - 2015년 배포.
    - 이미지의 영역을 나눠, 각 영역에 대한 경제 상자와 확률을 예측
...
- [주피터노트북](./day08/mldl01_YOLO_start.ipynb)
